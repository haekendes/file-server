...
class AuditServiceInMemoryTest {
    ...
    void testInMemotyRolingBuffer() {
        ...
        auditService.storeAudit(new AuditRecord(1546182100L, UserAccess.LOGIN, "user1", "", "login ok", null));
        auditService.storeAudit(new AuditRecord(1546182200L, UserAccess.LOGIN, "user1", "", "login ok", null));
        auditService.storeAudit(new AuditRecord(1546182300L, UserAccess.LOGIN, "user1", "", "login ok", null));
        ...
        auditService.storeAudit(new AuditRecord(1546182400L, UserAccess.LOGIN, "user1", "", "login ok", null));
